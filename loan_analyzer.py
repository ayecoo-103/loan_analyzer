...
# What is the average loan amount from the list? #550.0
...
# Print each variable.
x = loan.get("future_value") # x = future_value
y = loan.get("remaining_months") # y = remaining_months
print(x)
print(y)
...
if present_value >= loan_costs:
    print(f"The loan is worth to buy")
else: 
    print(f"The loan too expensive and not worth the price.")
